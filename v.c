...
V0(b3,1&$3(m,c<Xg,c>Xg,c==Xg),im,cc,RX)V0(B3,1&GI($3(m,j<X8,j>X8,j==X8)),im,ij,RX)V2(iV,$4(m,j+X6,j-X6,j*X6,x((i1)j*X6>>16,j>>16?X6-(j>>16)*x:x)),im,ij,RX)V0(d0,Xi,RX)V2(ig,IG(X4),RX)
V2(ei,EI(Xi),RX)V2(ie,IE(Xi),RX)V(sZ,ee=me(n,X);N2(E(Xi-e))e=1/se(n,R);N2(e*Ri),RX)V2(eZ,E(Xi),RX)V2(qZ,q(Xi),RX)V2(r2,R2(*--X),RX)V2(dV,e*Xi,ee,RX)V2(eV,$4(m,e+Xi,e-Xi,e*Xi,e/Xi),im,ee,RX)
V(RZ,ee=1/q(vv(n,X,X)/n-ze)[0];N2(e*Ai*Xi),EA,RX)V0(AO,1>m?Ag&Xg:Ag|Xg,im,EA,RX)V2(IV,$9(m,A6+Xi,A6-Xi,A6*Xi,G2(A,Xi),Ai+Xi,Ai-Xi,Ai*Xi,Ai/Xi,Ai*Xi/(1+E(-Xi))),im,EA,RX)
...
V(mv,er=R;i(.7*m,ri=vv(n,A+n/16*i,X)),im,EA,RX)V(vm,e2*a=A;n/=16;i(n/4,Ez[4]={};i(k,j(4,zj+=ai*Xj)X+=n)j(4,*R++=zj)X-=k*n-4),ik,EA,RX)V(mm,i(.5*m,vm(k,A,n,R,X);A+=k;R+=n/16),im,ik,EA,RX)
