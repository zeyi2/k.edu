...
#define VB(g,a,z) V0(g,b0(z),ij,a,iI,UR,VX)
...
V0(r0,R0(*--X),U3)V2(r2,R2(*--X),U3)V2(gb,GB(((U*)X)[i]),U3)V2(gi,GI(X8),U3)V2(ig,IG(X4),U3)V2(ei,EI(Xi),U3)V2(ie,IE(Xi),U3)V2(eZ,E(Xi),U3)V2(q_,Xi*Xi,U3)V2(_q,qq(Xi),U3)
...
_(sZ,ee=me(I,X);i(n4(I),Ri=E(Xi-e))e=1/se(I,R);i(n4(I),Ri*=e),U3)_(a0,i(n4(I),R4=c(A(A,Xi,1),g4)),U4)_(RZ,ee=1/qq(vv(I,X,X)/I-ze)[0];i(n4(I),Ri=e*Ai*Xi),U4)
