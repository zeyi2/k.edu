...
typedef unsigned long U,i3,j6 _(6),(*UF)();
typedef char i0,g4 _(4),g5 _(5),g6 _(6);typedef unsigned short i1;typedef unsigned i2,i4 _(4),i5 _(5),i6 _(6);typedef float e2,e5 _(5),e6 _(6);typedef int s6 _(6);
#undef _
...
#define h(b,z) {i2 $=b;ih=0;while(h<$){z;++h;}}
#define j(b,z) {i2 $=b;ij=0;while(j<$){z;++j;}}
...
#define D(t,g,z,x...) AT(minsize,noinline)_D(t,g,z,x)
...
#define _x(z) _(typeof(z)z9=_(z);_r(x);z9)
#define _a(z) _(typeof(z)z9=_(z);_r(a);z9)
...
#define V3(g,z) _D(g6,g,z,Va,Vb,Vc)
...
#define XX g4*X
#define XR g4*R
#define Qi(b,i) if(b)return err(i,__func__);
#define Qz(b) Qi(b,0)
#define Qr(b) Qi(b,1)
#define Qn(b) Qi(b,2)
#define Qt(b) Qi(b,3)
