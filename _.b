...
U _k(U),w_(i2,ss),wx(U);Ui(wc,w_(1,&i);0)is(wl,w_(i,s);wc(10))is(ic,sd=s;W(i!=*s)++s;s-d)Us(ws,wl(ic(0,s),s))f(wu,g0 d[17];d[16]=10;i(16,in=15&x>>60-4*i;d[i]="0W"[9<n]+n)w_(17,d);x)
Ui(wi,g0 d[12];d[11]=10;g0*s=d+11;in=i>>31?-i:i;do*--s=48+n%10;W(n/=10);if(i>>31)*--s=45;w_(d+12-s,s);i)Ui(tb,t(1,i))Ui(ti,t(2,i))U(te,t(5,*(i2*)&e),ee)f(iz,3>tx?x:(int)ex)
f(nu,o(popcountl)(x))f(iu,x?o(ctzl)(x):64)f(lu,--x?64-o(clzl)(x):0)
