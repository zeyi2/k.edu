...
e6(EI,o(convertvector)(x,e6),s6 x)
j6(JI,o(convertvector)(x,j6),i5 x)i6(IG,o(convertvector)(x,i6),g4 x)g6(GI,1&o(convertvector)(x,g6),i8 x)

#define O(f) o(ia32_##f##512)
Ef(q,O(sqrtps)(x,4))Ef(IE,o(ia32_cvtps2dq512_mask)(x,z0,-1,9))EF(d8,EI(O(vpdpbusd)(z2,a,x)))U(b2,O(cvtd2mask)(x),Vx)
i6(G2,o(ia32_gathersiv16si)(z0,s,x,-1,4),ss,Vx)GF(MG,O(pmaxub)(a,x))IF(LI,O(pminsd)(a,x))IF(MI,O(pmaxsd)(a,x))
