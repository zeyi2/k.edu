...
f(e,x=x?:Y(N());ii=*s---B;B>i?e(Y(3>i-29>v(*s)?_(Uf=Y(n());Ua=Y(N());_a(_f((B>f?30>i?z:Z:X)(f,a,x)))):i?y(i,v(*s)?29>i?0:*s---B:Y(N()),x):_(S(*s-97,x);64>*--s?r_(x):B))):x)
...
f(wx,px?B>x?wl(1,P+x):0:ax?wd($a(0,tx,jx,d)):tx?nx?1==tx&B<=*sx?(10-sx[nx-1]?wl:w)(nx,sx):wm(x):0:_(i(nx,wx(xj))x);x)U(_p,i(32,_r(Ai);Ai=0)0)
