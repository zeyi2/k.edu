...
ss;Ui(P_,"-+ .3$%=@A#!1\"2>& *         ')(-,____5______786___49________?_0/"[64>i?i:i-76])
is(ib,iu(~b0((i0)i!=Vs)))Z0*f,l;is(ns,R(1,i,*rV=Vs))is(gs,r(ns(i,s),*rV&=15))
...
_U(ls,ii;Ua=Q(m_(&i,s));s=(i0*)a;L(10,in=0;W(++n<i&&'/ '-*(i1*)(s+n));W(B==s[--n]);w(n+1,s))_m(a,i),ss)
