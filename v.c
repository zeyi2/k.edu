...
#define b4(g,a,b,x...) e2(g,Se(r(ze,I=n4(I);Ez[4]={};i(I/4,i(4,zi+=a*R++))i(I%4,r+=b Ri)i(4,r+=zi)))[15],x)
b4(se,,,IR)b4(vv,*X++*,Xi*,RX)i2(s2,i(n4(I),Ub=b2(n==(i6)Ri);P(b,16*i|iu(b)))I,in,IR)
_(mv,i(I,((e2*)R)[i]=vv(J,A+J*i,X)),aX)_(vm,J/=16;j(J/4,Ez[4]={};i(I,j(4,zj+=Ai*Xj)X+=J)j(4,*R++=zj)X-=I*J-4)i(J%4,Ri=r(ze,i(I,r+=Ai*X[J*i])++X)),aX)
