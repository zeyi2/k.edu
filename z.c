...
f(e,x=x?:Y(N());ii=*s---B;B>i?e(Y(3>i-29>v(*s)?_(Uf=Y(n());Q(B<=f)Ua=Y(N());_a((30>i?z:Z)(f,a,x))):i?y(i,v(*s)?29>i?0:*s---B:Y(N()),x):_(S(*s-97,x);64>*--s?r_(x):B))):x)
#define qn(x) (10>x-48|27>x-96|41==x|93==x)//[^0a)]-2+3 .999 9.99 99.9 999. 99e9
i2($e,*s++="+-"[0>e];ii=L(e=m(e,-e)+5e-5);4>i?(s[$l(i,e,s)]=46,$l(3-i,E[3-i]*(e-(i2)e),s+i+1)):10>i?(s[$l(2,e/E[i-2],s)]=101,s[3]=46+i):ni(e==e,s);4,ee,ss)
...
Ui(P_,",+ .3$%=@A#!1\"2>& *         ')(-,____5______786___49_______B?C0/"[64>i?i:i-76])U(bn,Ua=b0(10>x-48);a|b0(B==x|46==x|101==x)&a<<1|b0(45==x)&~(qn(i)|b0(qn(x))<<1),ii,Vx)Ui(qd,10>i-48)
ins(vs,it=i;cc=7-t?B:96;sd=s+n;im=nc(n,c,s);m++?x(k_(t,m),i(m,n=l((i2)(d-s),ib(c,s));$3(t-2>>1,xi=i$(n,s),xe=e$(n,s),xj=n$(n,s));s+=n+1)x):$3(t-2>>1,ti(i$(n,s)),te(e$(n,s)),t(7,n$(n,s))))
...
is(p,A=Ci;sd=Fi;*++d=64;ij=0;it;W(t=*s;B<t&59!=t)(s+=Y(js(d>Fi+1?s[-1]:B,j,t=34==t?0:48==t&qd(s[1])?:qd(s[1>t-45&v(*d)])?2:96==t?7:26>t-97?t:P_(t-B),s)),*++d=8>t?j++:t);*Fi=d-Fi;i)
//write Ui($p,ss=Fi+2;r(*Fi-1,i(r,d[i]=B>si?48+si:96>si?P[si-B]:si)))wd($p(x))
...
f(wx,px?x%B?wl(1,P+x):0:ax?wd($a(0,tx,jx,d)):_x(nx?1==tx&B<=*sx?(10-sx[nx-1]?wl:w)(nx,sx):tx?wm(x):ws("lst"):0);x)
#define X(c,z) Ux=0;sd=s+i;in=-1;W((s+=n+1)<d&&(n=(10-c?ib:ic)(c,s))&&(x=_(z)));//repl 
U(_p,i(32,_r(Ai);Ai=0)0)is(q,si=0;X(59,'::'==*(i1*)(s+1)?S(*s-97,p(*s%B,s+3)):r(c(p(0,s)),_p()))x)Us(ls,ii;Uf=m_(&i,s);s=(i0*)f;X(10,47-*s?a(n,s):B)_M(f,i);B)
